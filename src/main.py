...
class Interpreter(object):
    ...
    def get_next_token(self):
        ...
        # is self.pos index past the encd of self.text?
        # if so, return EOF token because there is no more input left to convert into tokens
        ...
        # create an INTEGER token, increment self.pos index to point to the next character after the digit,
    ...
    def expr(self):
        ...
        # at this point INTEGER PLUS INTEGER sequence of tokens has been successfully
